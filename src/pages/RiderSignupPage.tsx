                    ...
                    >
                        <div className="bg-white border-4 border-accent-dark rounded-3xl p-8 lg:p-12 shadow-chunky">
                            <div className="mb-10 text-center lg:text-left">
                                <h2 className="text-3xl font-black text-accent-dark mb-2">Join the Fleet</h2>
                            ...
                            <div className="mt-10 pt-8 border-t-2 border-accent-dark/5 flex flex-col items-center gap-4">
                                <p className="text-sm font-bold text-accent-dark/60">
                                    ...
                                    <Link className="ml-1 text-accent-dark underline decoration-primary decoration-4 underline-offset-2 hover:text-primary transition-colors font-black" to="/rider-login">Log in here</Link>
                                </p>
                            </div>
                        </div>
                    </motion.div>
