                    ...
                    >
                        <div className="bg-white border-4 border-accent-dark rounded-3xl p-8 lg:p-10 shadow-chunky">
                            ...
                            <p className="mt-10 text-center text-sm font-bold text-accent-dark/60">
                                ...
                                <Link className="ml-1 text-accent-dark underline decoration-primary decoration-4 underline-offset-2 hover:text-primary transition-colors font-black" to="/signup">Sign up for free</Link>
                            </p>
                        </div>
                    </motion.div>
                </div>
