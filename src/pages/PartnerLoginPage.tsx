    ...
    return (
        <div className="bg-background-light text-accent-dark antialiased font-display min-h-screen flex flex-col">
            <main className="flex-1 flex flex-col lg:flex-row">
                ...
                <div className="hidden lg:flex flex-1 items-start justify-center p-20 pt-32 lg:pt-40 relative overflow-hidden bg-primary border-r-4 border-accent-dark px-6 lg:px-20">
                        ...
                        <div className="bg-white border-4 border-accent-dark rounded-3xl p-8 lg:p-10 shadow-chunky">
                            ...
                            <form className="space-y-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        id="restaurant-email"
                                        placeholder="partner@nibble.com"
                                        type="email"
                                    />
                                </div>
                                <div>
                            ...
                            <div className="mt-10 pt-8 border-t-2 border-accent-dark/5 flex flex-col items-center gap-4">
                                <p className="text-sm font-bold text-accent-dark/60">
                                    Not a partner yet?
                                    <Link className="ml-1 text-accent-dark underline decoration-primary decoration-4 underline-offset-2 hover:text-primary transition-colors font-black" to="/partner-signup">Start selling today</Link>
                                </p>
                            </div>
                        </div>
                    </motion.div>
