    ...
    return (
        <div className="bg-background-light text-accent-dark antialiased font-display min-h-screen flex flex-col pt-24">
            <main className="flex-1 flex flex-col lg:flex-row">
                {/* Left Section - Squad illustration */}
                <div className="hidden lg:flex flex-1 items-center justify-center p-20 relative overflow-hidden bg-primary px-6 lg:px-20">
                    <div className="max-w-xl relative z-10 text-center">
                        ...
                        >
                            Join the <span className="bg-white px-4 py-1 inline-block mt-2">Hero Squad!</span>
                        </motion.h1>
                        <motion.div
                        ...
                        >
                            <div className="w-80 h-80 rounded-full border-8 border-accent-dark bg-white flex items-center justify-center shadow-chunky overflow-hidden">
                                <img
                                    ...
                                    alt="Friendly taco mascot wearing a party hat"
                            ...
                            <motion.div
                                ...
                                className="absolute -top-4 -right-4 bg-primary border-4 border-accent-dark rounded-2xl p-4 shadow-chunky-sm"
                            >
                            ...
                            <motion.div
                                ...
                                animate={{ opacity: 1, scale: 1 }}
                                transition={{ delay: 1 }}
                                className="absolute -bottom-6 -left-6 bg-white border-4 border-accent-dark rounded-full p-4 shadow-chunky-sm rotate-12"
                            >
                                <span className="material-symbols-outlined text-4xl font-black text-primary">stars</span>
                            </motion.div>
                        </motion.div>
                    </div>
                    {/* Decorative elements */}
                    ...
                    <div className="absolute top-20 right-20 w-8 h-8 bg-accent-dark rounded-full opacity-10"></div>
                </div>
                    ...
                    >
                        <div className="bg-white border-4 border-accent-dark rounded-3xl p-8 lg:p-10 shadow-chunky">
                            <div className="mb-10 text-center lg:text-left">
                                <h2 className="text-3xl font-black text-accent-dark mb-2">Create Account</h2>
                                <p className="text-accent-dark/60 font-bold">Start your hero journey today!</p>
                            </div>
                            <form className="space-y-5">
                                <div>
                                    <label className="block text-sm font-black text-accent-dark uppercase tracking-wider mb-2" htmlFor="fullname">
                                        Full Name
                                    </label>
                                    <input
                                ...
                                <div>
                                    <label className="block text-sm font-black text-accent-dark uppercase tracking-wider mb-2" htmlFor="password">
                                        Password
                                    </label>
                                    <input
                                        className="w-full px-5 py-4 bg-background-light border-2 border-accent-dark rounded-2xl focus:ring-0 focus:border-primary text-accent-dark font-bold placeholder:text-accent-dark/30 transition-all"
                                ...
                                <div className="flex items-start gap-3 py-2">
                                    ...
                                    <label className="text-xs font-bold text-accent-dark/70" htmlFor="terms">
                                        I agree to the <a className="underline font-black text-accent-dark" href="#">Terms of Service</a> and <a className="underline font-black text-accent-dark" href="#">Privacy Policy</a>
                                    </label>
                                </div>
                            ...
                            <div className="flex justify-center gap-6">
                                {[
                                    ...
                                    <button key={idx} className="w-14 h-14 rounded-full border-2 border-accent-dark flex items-center justify-center bg-white hover:bg-primary transition-all shadow-chunky-sm hover:translate-y-1 hover:shadow-none">
                                        {social.isCustom ? (
                            ...
                            <p className="mt-8 text-center text-sm font-bold text-accent-dark/60">
                                Already a Hero?
                                <a className="ml-1 text-accent-dark underline decoration-primary decoration-4 underline-offset-2 hover:text-primary transition-colors font-black" href="#">Log In</a>
                            </p>
                        </div>
                    </motion.div>
                </div>
