...
const CheckoutNavbar: React.FC = () => {
    return (
        <header className="fixed top-0 left-0 right-0 z-50 px-6 py-2 lg:px-12">
            <nav className="max-w-7xl mx-auto flex items-center justify-between bg-white/80 backdrop-blur-md border-2 border-accent-dark rounded-full px-6 py-2 shadow-chunky-sm min-h-[52px]">
                {/* Branding */}
